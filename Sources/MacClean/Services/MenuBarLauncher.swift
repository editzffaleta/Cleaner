    ...
    public enum LauncherError: Error, LocalizedError {
        ...
        public var errorDescription: String? {
            ...
            case .registrationFailed(let msg):
                return L10n.tr("无法启用菜单栏小组件：\(msg)", "Não foi possível ativar o widget da barra de menus: \(msg)")
            case .unregisterFailed(let msg):
                return L10n.tr("无法停用菜单栏小组件：\(msg)", "Não foi possível desativar o widget da barra de menus: \(msg)")
            }
        }
    }
